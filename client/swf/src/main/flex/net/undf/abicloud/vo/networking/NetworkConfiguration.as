...
package net.undf.abicloud.vo.networking
{
    ...
    [RemoteClass(alias="com.abiquo.abiserver.pojo.networking.NetworkConfiguration")]
    [Bindable]
    public class NetworkConfiguration
    {

        public var networkConfigurationId:int;
        ...
        public var sufixDNS:String;

        public var fenceMode:String;
