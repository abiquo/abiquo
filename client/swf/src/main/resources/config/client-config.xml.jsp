...
<params>
	...
	<param>
		...
		<name>GOOGLE_MAPS_LOAD_TIMEOUT</name>
		<value>10</value>
	</param>
	
	<param>
		<!-- Google Maps will be centered by default at this latitude value -->
		<name>GOOGLE_MAPS_DEFAULT_LONGITUDE</name>
		<value>42</value>
	</param>
	
	<param>
		<!-- Google Maps will be centered by default at this longitude value -->
		<name>GOOGLE_MAPS_DEFAULT_LATITUDE</name>
		<value>-96</value>
	</param>
	
	<param>
		<!-- Google Maps will be centered by default with this zoom level value -->
		<name>GOOGLE_MAPS_DEFAULT_ZOOM</name>
		<value>4</value>
	</param>
	
	<param>
		<!-- Time interval in seconds -->
		<name>INFRASTRUCTURE_UPDATE_INTERVAL</name>
		<value>30</value>
	</param>
	
	<param>
		<!-- Time interval in seconds -->
		<name>VIRTUAL_APPLIANCES_UPDATE_INTERVAL</name>
		<value>30</value>
	</param>
	
	<param>
		<!-- Time interval in seconds -->
		<name>VIRTUAL_APPLIANCE_DEPLOYING_UPDATE_INTERVAL</name>
		<value>5</value>
	</param>
	
	<param>
		<!-- Time interval in seconds -->
		<name>OVFPACKAGES_DOWNLOADING_PROGRESS_UPDATE_INTERVAL</name>
		<value>10</value>
	</param>
	
	<param>
		<!-- Time interval in seconds -->
		<name>VIRTUALIMAGE_UPLOAD_PROGRESS_UPDATE_INTERVAL</name>
		<value>10</value>
	</param>
	
	<param>
		<!--  Time interval in seconds -->
		<name>METERING_UPDATE_INTERVAL</name>
		<value>10</value>
	</param>
	
	<param>
		<!-- Number of users per page that will appear in User Management -->
		<name>NUMBER_USERS_PER_PAGE</name>
		<value>25</value>
	</param>
	
	<param>
		<!-- Number of enterprises per page that will appear in User Management -->
		<name>NUMBER_ENTERPRISES_PER_PAGE</name>
		<value>25</value>
	</param>
	
	<param>
		<!-- Number entries that will appear when listing IP addresses in different parts of the application -->
		<name>NUMBER_IP_ADDRESSES_PER_PAGE</name>
		<value>25</value>
	</param>
		...
		<value>
			<channels>
				<channel>
					<id>my-amf</id>
					<type>amf</type>
					<endpoint>/server/messagebroker/amf</endpoint>
				</channel>
				
				<channel>
					<id>my-secure-amf</id>
					<type>amfsecure</type>
					<endpoint>https://<%= request.getHeader("host") %>/server/messagebroker/amfsecure</endpoint>
				</channel>
			</channels>
		</value>
	</param>
