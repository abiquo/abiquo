...
public abstract class AbstractGeneratorTest extends AbstractTestNGSpringContextTests
{
    ...
    public void tearDown()
    {
        String[] entities =
            ...
            "network_configuration", "storage_pool", "tier", "storage_device", "remote_service",
            ...
            "role_ldap", "role", "privilege", "enterprise_properties_map", "enterprise_properties",
            "enterprise", "enterprise_limits_by_datacenter", "workload_enterprise_exclusion_rule",
