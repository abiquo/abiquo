...
public class SecurityService
{
    ...
    {
        return new String[] {ENTRPRISE_ADMINISTER_ALL, PHYS_DC_ENUMERATE,
        USERS_MANAGE_OTHER_ENTERPRISES, USERS_MANAGE_ROLES_OTHER_ENTERPRISES,
        USERS_MANAGE_SYSTEM_ROLES, USERS_MANAGE_USERS, USERS_VIEW, USERS_VIEW_PRIVILEGES,
        USERS_PROHIBIT_VDC_RESTRICTION, USERS_MANAGE_LDAP_GROUP, VDC_ENUMERATE, USERS_MANAGE_ROLES};
    }
