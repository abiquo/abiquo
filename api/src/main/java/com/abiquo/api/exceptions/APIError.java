...
public enum APIError
{
    ...
    VLANS_PRIVATE_MAXIMUM_REACHED("VLAN-0",
        ...
        "VLAN-10",
        "Attributes 'address', 'mask' and 'tag' cannot be changed by the Edit process of private VLAN."), VLANS_DEFAULT_NETWORK_CAN_NOT_BE_DELETED(
    ...
    NON_EXISTENT_VIRTUALAPPLIANCE("VAPP-0", "The requested virtual appliance does not exist"), VIRTUALAPPLIANCE_NOT_DEPLOYED(
        ...
        "VAPP-5", "The virtual appliance cannot be deleted because it is DEPLOYED or LOCKED. Should be NOT_DEPLOYED or UNKNOWN"), VIRTUALAPPLIANCE_MOVE_MISSING_VDC(
        "VAPP-6", "The virtual appliance cannot be deleted because it has no virtual datacenter link"), VIRTUALAPPLIANCE_INVALID_STATE_MOVE_COPY(
        "VAPP-8", "The virtual appliance cannot be moved or copied because it is DEPLOYED or LOCKED. Should be NOT_DEPLOYED or UNKNOWN"), VIRTUALAPPLIANCE_INVALID_DC_MOVE_COPY(
        "VAPP-7",
        ...
        "VAPP-10",
        "The virtual appliance cannot be moved or copied because it contains virtual machine templates that are incompatible with the hypervisor to be moved"), VIRTUALAPPLIANCE_COPY_PERSISTENT_VM(
        "VAPP-11",
    ...
    VIRTUAL_MACHINE_WITHOUT_HYPERVISOR("VM-0",
        ...
        "VM-28", "Cannot reconfigure to a non-managed virtual machine template"), VIRTUAL_MACHINE_RECONFIGURE_NOT_MANAGED(
    ...
    VIMAGE_INVALID_ALLOCATION_UNITS("VIMAGE-INVALID-OVF-ALLOCATION-INITS",
        ...
        "VIMAGE-5", "Change in Datacenter Repository of a Virtual Machine Template is not allowed"), VMTEMPLATE_MASTER_TEMPLATE_CANNOT_BE_CHANGED(
