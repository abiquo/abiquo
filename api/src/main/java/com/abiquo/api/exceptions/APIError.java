...
public enum APIError
{
    ...
    NON_EXISTENT_MACHINE("MACHINE-0", "The requested machine does not exist"), NOT_ASSIGNED_MACHINE_DATACENTER_RACK(
        ...
        "MACHINE-7",
        "Machine cannot be removed because it is managed by the high availability engine. Manually re-enable it to recover managed state."), MANAGED_MACHINE_CANNOT_CHANGE_NAME(
        ...
        "Invalid ip range"), MACHINE_IQN_MISSING("MACHINE-11",
