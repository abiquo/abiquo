...
public enum APIError
{
    ...
    NON_EXISTENT_ENTERPRISE("EN-0", "The requested enterprise does not exist"), ENTERPRISE_DUPLICATED_NAME(
        ...
        "ENTERPRISE-9",
        "Cannot delete enterprise because some users have roles that cannot be deleted, please change their enterprise before continuing"), MISSING_PRICING_TEMPLATE_LINK(
    ...
    NON_EXISTENT_ROLE("ROLE-0", "The requested role does not exist"), NON_MODIFICABLE_ROLE(
        ...
        "ROLE-7", "Cannot create a global role with the same name of an existing global role"), HAS_NOT_ENOUGH_PRIVILEGE(
    ...
    NOT_ASSIGNED_USER_ENTERPRISE("USER-0", "The user is not assigned to the enterprise"), MISSING_ROLE_LINK(
        ...
        "The user cannot delete his own user account"), USER_PASSWORD_IS_NECESSARY("USER 11",
        "The field password is necessary"),
