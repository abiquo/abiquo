...
/**
     ...
     * @param backUpVm
     */
    private void insertBackUpResources(VirtualMachine backUpVm)
    {
     ...
     */
    private void updateVirtualMachineToNewValues(final VirtualAppliance vapp, VirtualMachine old,
     ...
     */
    private boolean resourceIntoNewList(RasdManagement resource,
        List< ? extends RasdManagement> newResources)
    {
     ...
     */
    private boolean volumeIntoNewList(VolumeManagement volume, List<VolumeManagement> volumes)
    {
    ...
    protected void allocateNewStorages(final VirtualAppliance vapp, final VirtualMachine vm,
        List< ? extends RasdManagement> resources, final List<Integer> blackList)
    {
    ...
    protected void allocateNewNICs(final VirtualAppliance vapp, final VirtualMachine vm,
        List<IpPoolManagement> resources, final List<Integer> blackList)
    {
        // When we allocate a resource, we need to set a unique attachment order for each one.
        // The function #getStorageFreeAttachmentSlot do the work. However, it only takes
        // the information from database, and we need to have a list of integers of the
     ...
     */
    protected void createBackUpResources(final VirtualMachine vm, VirtualMachine tmp)
    {
        // Backup disks
    ...
    * */
    ...
    protected boolean allocateResource(final VirtualMachine vm, final VirtualAppliance vapp,
        RasdManagement resource, final Integer attachOrder)
    {
