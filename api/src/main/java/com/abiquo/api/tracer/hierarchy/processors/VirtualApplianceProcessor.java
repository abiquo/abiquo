...
/**
 * Processes the hierarchy to extract {@link VirtualAppliance} data.
 * 
 * @author ibarrera
 */
@Service
public class VirtualApplianceProcessor extends AbstractHierarchyProcessor<VirtualAppliance>
{
    /** The DAO used to get the resource information. */
    @Autowired
    private VirtualApplianceRep dao;

    @Override
    protected String getIdentifierPrefix()
    {
        return VirtualAppliancesResource.VIRTUAL_APPLIANCES_PATH;
    }
