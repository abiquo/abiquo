...
/**
 * Encapsulates all the exceptions coming from the {@link DatastoreCommand}.
 * 
 * @author jdevesa@abiquo.com
 */
public class DatastoreCommandException extends AbiCloudException
{
     ...
     */
    public DatastoreCommandException(String message)
    {
        super(message);
    }
     ...
     */
    public DatastoreCommandException(String message, int abicloudErrorCode)
    {
     ...
     */
    public DatastoreCommandException(String message, Throwable e)
    {
        super(message, e);
    }
     ...
     */
    public DatastoreCommandException(String message, Throwable e, int abicloudErrorCode)
    {
     ...
     * @param e The exception to be thrown
     */
    public DatastoreCommandException(Throwable e)
    {
        super(e);
    }
     ...
     * @param abicloudErrorCode code error
     */
    public DatastoreCommandException(Throwable e, int abicloudErrorCode)
    {
