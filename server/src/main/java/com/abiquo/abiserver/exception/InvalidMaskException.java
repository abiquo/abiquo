...
public class InvalidMaskException extends NetworkCommandException
{
     ...
     */
    public InvalidMaskException(String message, int abicloudErrorCode)
    {
     ...
     */
    public InvalidMaskException(String message, Throwable e)
    {
        super(message, e);
    }
     ...
     */
    public InvalidMaskException(String message, Throwable e, int abicloudErrorCode)
    {
     ...
     * @param e The exception to be thrown
     */
    public InvalidMaskException(Throwable e)
    {
        super(e);
    }
