...
/**
 * This class encapsulates all the Infrastructure command possible exceptions
 * 
 * @author abiquo
 */
public class InfrastructureCommandException extends AbiCloudException
{
    /**
     ...
     */
    public InfrastructureCommandException(String message)
    {
        super(message);
    }
     ...
     */
    public InfrastructureCommandException(String message, int abicloudErrorCode)
    {
     ...
     */
    public InfrastructureCommandException(String message, Throwable e)
    {
        super(message, e);
    }
     ...
     */
    public InfrastructureCommandException(String message, Throwable e, int abicloudErrorCode)
    {
