...
/**
 * This class encapsulates all the VirtualImageCommand possible exceptions
 * 
 * @author xfernandez@abiquo.com
 */
public class VirtualImageCommandException extends AbiCloudException
{
    /**
     ...
     */
    public VirtualImageCommandException(String message)
    {
        super(message);
    }
     ...
     */
    public VirtualImageCommandException(String message, int abicloudErrorCode)
    {
     ...
     */
    public VirtualImageCommandException(String message, Throwable e)
    {
        super(message, e);
    }
     ...
     */
    public VirtualImageCommandException(String message, Throwable e, int abicloudErrorCode)
    {
     ...
     * @param e The exception to be thrown
     */
    public VirtualImageCommandException(Throwable e)
    {
        super(e);
    }
     ...
     * @param abicloudErrorCode code error
     */
    public VirtualImageCommandException(Throwable e, int abicloudErrorCode)
    {
