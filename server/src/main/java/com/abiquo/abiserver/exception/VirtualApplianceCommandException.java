...
public class VirtualApplianceCommandException extends AbiCloudException
{
     ...
     */
    public VirtualApplianceCommandException(String message)
    {
        super(message);
    }
     ...
     */
    public VirtualApplianceCommandException(String message, int abicloudErrorCode)
    {
     ...
     */
    public VirtualApplianceCommandException(String message, Throwable e)
    {
        super(message, e);
    }
     ...
     */
    public VirtualApplianceCommandException(String message, Throwable e, int abicloudErrorCode)
    {
     ...
     * @param e The exception to be thrown
     */
    public VirtualApplianceCommandException(Throwable e)
    {
        super(e);
    }
     ...
     * @param abicloudErrorCode code error
     */
    public VirtualApplianceCommandException(Throwable e, int abicloudErrorCode)
    {
