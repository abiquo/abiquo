...
/**
 * Specific interface to work with the {@link DatastoreHB} Exposes all the methods that this entity
 * will need to interact with the data source
 * 
 * @author pnavarro@abiquo.com
 */
public interface DatastoreDAO extends DAO<DatastoreHB, Integer>
{
