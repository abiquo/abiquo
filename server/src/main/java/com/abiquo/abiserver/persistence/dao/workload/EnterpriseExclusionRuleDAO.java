...
public interface EnterpriseExclusionRuleDAO extends DAO<EnterpriseExclusionRuleHB, Integer>
{
    public List<EnterpriseHB> findExcludedEnterprises(EnterpriseHB enterprise);

    public List<PhysicalmachineHB> findMachinesWithVMsFromExcludedEnterprises(
        EnterpriseHB enterprise);
}
