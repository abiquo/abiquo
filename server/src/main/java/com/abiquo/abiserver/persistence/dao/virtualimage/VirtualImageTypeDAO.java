 ...
 * {@link com.abiquo.abiserver.business.hibernate.pojohb.virtualimage.VirtualimageTypeHB} Exposes
 * all the methods that this entity will need to interact with the data source
 * 
 * @author jdevesa@abiquo.com
 */
public interface VirtualImageTypeDAO extends DAO<VirtualimageTypeHB, Integer>
{
