 ...
 * com.abiquo.abiserver.business.hibernate.pojohb.interface.RemoteServiceHB} Exposes all the methods
 * that this entity will need to interact with the data source
 */
public interface RemoteServiceDAO extends DAO<RemoteServiceHB, Integer>
{
    // Declare all the needed extra functions
