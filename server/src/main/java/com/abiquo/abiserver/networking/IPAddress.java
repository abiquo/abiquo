...
public class IPAddress
{
     ...
     * @throws InvalidIPAddressException if the reference ip is invalid representation of an IP
     *             address.
     */
    public static IPAddress newIPAddress(String ipAddress) throws InvalidIPAddressException
    {
        ...
        {
            throw new InvalidIPAddressException("Invalid IP parameter");
        }
     ...
     */
    public IPAddress nextIPAddress() throws InvalidIPAddressException
    {
        StringTokenizer tokenizer = new StringTokenizer(ip, ".");
