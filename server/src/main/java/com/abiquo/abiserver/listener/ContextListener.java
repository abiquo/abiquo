...
public class ContextListener implements ServletContextListener {
	...
	public void contextInitialized(final ServletContextEvent sce) {
		try {
			String contextName = sce.getServletContext()
			...
			LOGGER.info("The context [" + contextName
	 ...
	 * {@link VSMCallback} and starts the consuming.
	 * 
	 * @throws IOException
	 *             When there is some network error.
	 */
	...
	/**
	 * Registers the {@link TracerCollector} and all the default
	 * {@link TracerProcessor}.
	 */
