...
public class VirtualApplianceWS implements IVirtualApplianceWS
{
    ...
    /** The logger object */
    // private final static Logger logger = LoggerFactory.getLogger(VirtualApplianceWS.class);
     ...
     * (non-Javadoc)
     * @see
     * com.abiquo.abiserver.abicloudws.IVirtualApplianceWS#startVirtualAppliance(com.abiquo.abiserver
        ...
        throws Exception
    {
        ...
        BasicResult result = new BasicResult(); // TODO throw Exception on reportError
        ...
        try
        {
            ...
            if (resource != null)
            {
                // Starting the virtual Appliance Changing the virtualSystems to running
     ...
     * (non-Javadoc)
     * @see
     * com.abiquo.abiserver.abicloudws.IVirtualApplianceWS#shutdownVirtualAppliance(com.abiquo.abiserver
     * .pojo.virtualappliance.VirtualAppliance, boolean)
     */
        ...
        throws Exception
    {
        ...
        try
        {
            ...
            if (resultCheck)
            {
                ...
                if (resource != null)
                {
                    // Unsubscribing to every state in every Virtual appliance VM
     ...
     * (non-Javadoc)
     * @see
     * com.abiquo.abiserver.abicloudws.IVirtualApplianceWS#deleteVirtualAppliance(com.abiquo.abiserver
     * .pojo.virtualappliance.VirtualAppliance)
     */
        ...
        throws Exception
    {
        ...
        {
            encapsulateAndRethrowFault(virtualAppliance, e, EventType.VAPP_BUNDLE);
        }
        catch (RemoteServiceException e)
        {
            errorManager.reportError(VirtualApplianceWS.resourceManager, result,
     ...
     * (non-Javadoc)
     * @see
     * com.abiquo.abiserver.abicloudws.IVirtualApplianceWS#editVirtualAppliance(com.abiquo.abiserver
     * .pojo.virtualappliance.VirtualAppliance)
     */
        ...
        throws Exception
    {
        ...
        try
        {
            if (virtualAppliance.getState().toEnum() == StateEnum.APPLY_CHANGES_NEEDED)
            {
                ...
                // When there are no nodes left, its no need to update subscription.
     ...
     * (non-Javadoc)
     * @see
     * com.abiquo.abiserver.abicloudws.IVirtualApplianceWS#checkVirtualAppliance(com.abiquo.abiserver
     * .pojo.virtualappliance.VirtualAppliance, boolean)
     */
     ...
     * (non-Javadoc)
     * @see
     * com.abiquo.abiserver.abicloudws.IVirtualApplianceWS#bundleVirtualAppliance(com.abiquo.abiserver
     * .pojo.virtualappliance.VirtualAppliance)
     */
