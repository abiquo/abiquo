...
public class AbstractAPIStub
{
    ...
    protected String createCookbookLink(final Integer vdcId, final Integer vappId,
        final Integer virtualMachineId)
    {
        ...
        return resolveURI(
            apiUri,
            "cloud/virtualdatacenters/{vdc}/virtualappliances/{vapp}/virtualmachines/{vm}/config/cookbooks",
            params);
    }
}
