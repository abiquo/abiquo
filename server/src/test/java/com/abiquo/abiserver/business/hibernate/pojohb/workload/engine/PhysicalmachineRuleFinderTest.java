...
public class PhysicalmachineRuleFinderTest extends DataAccessTestBase
{
    ...
    // DatacenterHB unusedDatacenter =
    // TestEntityGenerationUtils.createDatacenter("unusedDatacenter");
    ...
    // RackHB unusedRack = TestEntityGenerationUtils.createRack(unusedDatacenter,
    // "rack1_2_noMachine");
    // PhysicalmachineHB machine1_1_1 = TestEntityGenerationUtils.createMachine(rack1_1,
    // "machine1_1_1");
    // PhysicalmachineHB machine1_1_2 = TestEntityGenerationUtils.createMachine(rack1_1,
    // "machine1_1_2");
    // PhysicalmachineHB machine1_1_3 = TestEntityGenerationUtils.createMachine(rack1_2,
    // "machine1_1_3");
    // PhysicalmachineHB machine1_1_4 = TestEntityGenerationUtils.createMachine(unusedRack,
    // "machine1_1_3");
    // PhysicalmachineHB machine2_1_1 = TestEntityGenerationUtils.createMachine(rack2_1,
    // "machine1_1_3");
    // PhysicalmachineHB unusedMachine = TestEntityGenerationUtils.createMachine(unusedRack,
    // "unusedMachine");
    ...
    // SessionUtils.saveAndFlush(session, datacenter1, datacenter2, unusedDatacenter, rack1_1,
    // rack1_2, rack2_1, unusedRack,
    // machine1_1_1, machine1_1_2, machine1_1_3, machine1_1_4, machine2_1_1, unusedMachine, rule1,
    // rule2, rule3, rule4);
    //
    ...
    // Map<PhysicalmachineHB, List<MachineLoadRuleHB>> result =
    // finder.chooseHigherPrecedenceMachineLoadRules(candidateMachines, rules);
    // // Test a machine that has direct rules at machine, rack and datacenter level: only machine
    // level ones must be selected
    // AssertUtils.assertContainsAllAndOnly(result.get(machine1_1_1), rule1);
    // // Test a machine that has indirect rules at rack and datacenter level: only rack level ones
    // must be selected
    // AssertUtils.assertContainsAllAndOnly(result.get(machine1_1_2), rule2);
    // // Test a machine that has indirect rules at datacenter level: only datacenter level ones
    // must be selected
    ...
    //
    // PhysicalmachineRuleFinder finder = new PhysicalmachineRuleFinder(session, candidateMachines);
    // List<MachineLoadRuleHB> result = finder.findCandidateMachineLoadRules(session,
    // candidateMachines);
