...
import com.abiquo.virtualfactory.hypervisor.impl.XenHypervisor;
...
/**
 * Xen Machine test case.
 * 
 * @author pnavarro
 */
public class XenMachineTest extends AbsMachineTest
{
     ...
     * Test constructor.
     */
    public XenMachineTest()
    {
        // HYPERVISOR configuration properties
        hvURL = "http://thunder05:18083";
        hvUser = "";
        hvPassword = "";
        ...
        cpuNumber = 1;
        macAddress = "00:16:3e:28:f5:f4";
        macAddress2 = "00:16:3e:28:f5:f5";
