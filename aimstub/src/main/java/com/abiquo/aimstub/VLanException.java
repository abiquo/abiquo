...
public class VLanException extends Exception implements TBase<VLanException._Fields>, java.io.Serializable, Cloneable, Comparable<VLanException> {
  ...
  public int compareTo(VLanException other) {
    ...
    VLanException typedOther = (VLanException)other;
