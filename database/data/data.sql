...
-- THIS IS NECESSARY TO start the script!
...
INSERT INTO `kinton_liquibase`.`auth_group` VALUES
 (1,'GENERIC', 'Generic'),
...
--
-- Dumping data for table `kinton_liquibase`.`network`
--
...
--
-- Dumping data for table `kinton_liquibase`.`alerts`
--
...
--
-- Dumping data for table `kinton_liquibase`.`apps_library`
--
...
--
-- Dumping data for table `kinton_liquibase`.`workload_fit_policy_rule`
--
...
--
-- Dumping data for table `kinton_liquibase`.`system_properties`
--
