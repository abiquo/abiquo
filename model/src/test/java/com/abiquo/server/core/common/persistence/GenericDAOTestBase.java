...
public abstract class GenericDAOTestBase<ID extends Serializable, DAO extends DefaultDAOBase<ID, T>, T extends GenericEnityBase<ID>>
    extends JpaHibernateDaoTestBase<DAO, T, ID>
{
