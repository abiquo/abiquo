...
@Entity
@Table(name = DatacenterResources.TABLE_NAME)
@org.hibernate.annotations.Table(appliesTo = DatacenterResources.TABLE_NAME)
public class DatacenterResources extends DefaultEntityBase
{
    public static final String TABLE_NAME = "dc_enterprise_stats";

    protected DatacenterResources()
    {
    }

    private final static String ID_COLUMN = "idDCEnterpriseStats";
    ...
    public final static String ID_DATA_CENTER_PROPERTY = "idDataCenter";

    private final static String ID_DATA_CENTER_COLUMN = "idDataCenter";

    private final static int ID_DATA_CENTER_MIN = Integer.MIN_VALUE;

    private final static int ID_DATA_CENTER_MAX = Integer.MAX_VALUE;

    @Column(name = ID_DATA_CENTER_COLUMN, nullable = true)
    @Range(min = ID_DATA_CENTER_MIN, max = ID_DATA_CENTER_MAX)
