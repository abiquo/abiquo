...
public class OVFPackage extends DefaultEntityBase
{
    ...
    public OVFPackage(AppsLibrary appslibary, String url, DiskFormatType diskFormatType)
    {
        setAppsLibrary(appslibary);
        setType(diskFormatType);
        setUrl(url);
    }
    ...
    private final static int PRODUCT_VERSION_LENGTH_MAX = 255;
    ...
    private final static boolean CATEGORY_REQUIRED = false;
    ...
    private final static int PRODUCT_VENDOR_LENGTH_MAX = 255;
    ...
    private final static int PRODUCT_URL_LENGTH_MAX = 255;
    ...
    protected final static int URL_LENGTH_MIN = 0;

    protected final static int URL_LENGTH_MAX = 255;
    ...
    private void setType(DiskFormatType type)
    {
        this.type = type;
    }
    ...
    private void setDiskSizeMb(long diskSizeMb)
    {
    ...
    @ManyToMany(targetEntity = OVFPackageList.class, mappedBy = "ovfPackages")
